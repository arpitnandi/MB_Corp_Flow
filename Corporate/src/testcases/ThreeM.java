...
public class ThreeM extends Corporate_class{
WebDriver driver;
	
	static Logger Log = Logger.getLogger(ThreeM.class.getName());
	...
	@Test
	public void threem() throws InterruptedException {
		 loginpage = new Login(driver);	    
		 loginpage.login("Test123@3M","Suresh@123");
