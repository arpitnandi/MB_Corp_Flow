...
public class WnsGlobal extends Corporate_class {
WebDriver driver;
	
	static Logger Log = Logger.getLogger(WnsGlobal.class.getName());
	...
	@Test
	public void wnsGlobal() throws InterruptedException {
		 loginpage = new Login(driver);	    
		 loginpage.login("Test_Self@WNS","Medi@123");
