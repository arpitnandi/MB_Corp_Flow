...
public class MicroChip extends Corporate_class {
WebDriver driver;
	
	static Logger Log = Logger.getLogger(MicroChip.class.getName());
	...
	@Test
	public void microChip() throws InterruptedException {
		 loginpage = new Login(driver);	    
		 loginpage.login("Test01@Microchip","Suresh@123");
