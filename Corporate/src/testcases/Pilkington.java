...
public class Pilkington extends Corporate_class{
WebDriver driver;
	
	static Logger Log = Logger.getLogger(Pilkington.class.getName());
	...
	@Test
	public void pilkington() throws InterruptedException {
		 loginpage = new Login(driver);	    
		 loginpage.login("test01@pilkington","Test123!.");
