...
public class Spic extends Corporate_class {
WebDriver driver;
	
	static Logger Log = Logger.getLogger(Spic.class.getName());
	...
	@Test
	public void spic() throws InterruptedException {
		 loginpage = new Login(driver);	    
		 loginpage.login("test13@SPIC","Test@123");
