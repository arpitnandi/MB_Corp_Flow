...
public class Ambit extends Corporate_class {
WebDriver driver;
	
	static Logger Log = Logger.getLogger(Ambit.class.getName());
...
//	}
	...
	@Test
	public void ambit() throws InterruptedException {
		 loginpage = new Login(driver);	    
		 loginpage.login("test_Ambit@Ambit","Test@123");
		 ...
		 Thread.sleep(5000);
		 mbPage.viewNonSponsoredPackage(); // package not loading - issue (dev reported)
