...
public class Titan extends Corporate_class {
WebDriver driver;
	
	static Logger Log = Logger.getLogger(Titan.class.getName());
	...
	@Test
	public void titan() throws InterruptedException {
		 loginpage = new Login(driver);	    
		 loginpage.login("Self_Titan@titan","Medi@123");
